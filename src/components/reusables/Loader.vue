...
.cube.panelLoad .cube-face {
    ...
    position: absolute;
    background: white;
    box-shadow: inset 0 0 0 1px #0A1045, 0 0 1px 1px #0A1045;
    opacity: 1;
}

.cube.panelLoad .cube-face-front {
    transform: translate3d(0, 0, 40px);
    font-size: 57px;
}

.cube.panelLoad .cube-face-back {
    transform: rotateY(180deg) translate3d(0, 0, 40px);
}

.cube.panelLoad .cube-face-left {
    transform: rotateY(-90deg) translate3d(0, 0, 40px);
}

.cube.panelLoad .cube-face-right {
    transform: rotateY(90deg) translate3d(0, 0, 40px);
}

.cube.panelLoad .cube-face-top {
    transform: rotateX(90deg) translate3d(0, 0, 40px);
}

.cube.panelLoad .cube-face-bottom {
    transform: rotateX(-90deg) translate3d(0, 0, 40px);
}
