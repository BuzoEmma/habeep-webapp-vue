  ...
  <div>
    ...
    >
      ...
      <ChooseMethod
        ...
        :enter="{ opacity: 1, y: 0, x: 0 }"
        :walletData="walletData"
        v-if="chooseWithdrawalMethodModal"
        @close="closeModal"
      ...
      <ChooseHBPMethod
        ...
        :enter="{ opacity: 1, y: 0, x: 0 }"
        :wallet="tokenWallet"
        v-if="chooseHBPWithdrawalMethodModal"
        @close="closeModal"
        @gotoTransfer="openWithdrawalHBPModal('transferHBP')"
        @gotoSwap="openWithdrawalHBPModal('swapHBPModal')"
      />
    </div>

    <div
      class="main w-screen min-w-full flex flex-col items-center bg-white h-full min-h-screen overflow-y-auto"
      :class="{
    ...
    >
      ...
      <div
        class="md:hidden flex flex-row gap-x-5 pl-3 items-center w-full pt-5"
      >
        <svg
      ...
      <div
        class="body h-full flex flex-col lg:w-4/6 md:w-4/5 w-full px-4 md:px-0 pt-5 xl:w-3/5"
      >
        <h1 class="text-2xl font-medium text-webapp md:block hidden">Wallet</h1>

        <div class="flex flex-row items-center mt-6 ml-7">
          <div
            class="cursor-pointer flex flex-row items-center justify-center w-24 py-4 pb-1"
          ...
          <div
            class="cursor-pointer flex flex-row items-center justify-center w-24 pb-1 py-4"
