            ...
            <div class="flex flex-col items-center w-5/6 xl:w-4/5 2xl:w-4/6 gap-y-10">
                <div class="flex-row-center w-full justify-between">
                    <img class="cursor-pointer" @click="$router.push('/')" src="../../assets/icons/habeep-logo-white.svg"
                        alt="">
                    <img class="cursor-pointer" src="../../assets/icons/gotohabeep.svg" @click="$router.push('/feeds')"
                        alt="">
                </div>
...
function searchArticles() {
    if (searchWord.value.length > 0) {
        ...
        for (const collection of collections) {
            if (collection.title.toLowerCase().includes(searchWord.value.toLowerCase()) || collection.subtitle.toLowerCase().includes(searchWord.value.toLowerCase()) || collection.writer.toLowerCase().includes(searchWord.value.toLowerCase())) {
                results.push(collection)
            }

            if (collection.articles.length > 0) {
                collection.articles.forEach(article => {
                    if (article.title.toLowerCase().includes(searchWord.value.toLowerCase()) || article.subtitle.toLowerCase().includes(searchWord.value.toLowerCase()) || article.content.toLowerCase().includes(searchWord.value.toLowerCase())) {
                        results.push(collection)
                    }
                })
            }
