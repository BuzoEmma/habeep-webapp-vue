    ...
    VitePluginSitemap({
      ...
      urlGenHook: async (config) => {
        ...
        try {
          ...
          let productsLinks = []
          const fetch = await axios.get('https://staging-habeep-api.habeep.org/backend/api/v1/seo/products')
          ...
          let usersLinks = []
          const fetchUsers = await axios.get('https://staging-habeep-api.habeep.org/backend/api/v1/seo/users')
          ...
          let blogsLinks = []
          const fetchBlogs = await axios.get('https://staging-habeep-api.habeep.org/backend/api/v1/seo/blogs')
